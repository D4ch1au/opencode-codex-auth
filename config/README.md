...
- ✅ Context limits (1M context / 128k output for GPT 5.4, 400k for GPT 5.3 Codex, 272k / 128k for GPT 5.2 and GPT 5.1 families)
...
- **gpt-5.4** (none/low/medium/high/xhigh) - Latest GPT 5.4 model with 1M context window
