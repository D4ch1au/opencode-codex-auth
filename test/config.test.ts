...
describe('Configuration Parsing', () => {
	...
	describe('getModelConfig', () => {
		...
		it('should preserve xhigh for gpt-5.3-codex', () => {
			const codex53 = getReasoningConfig('gpt-5.3-codex', {
				reasoningEffort: 'xhigh',
			});

			expect(codex53.effort).toBe('xhigh');
		});

		it('should upgrade none to low for gpt-5.3-codex', () => {
			const codex53 = getReasoningConfig('gpt-5.3-codex', {
				reasoningEffort: 'none',
			});

			expect(codex53.effort).toBe('low');
		});
